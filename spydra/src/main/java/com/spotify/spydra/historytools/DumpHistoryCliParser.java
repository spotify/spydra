...
public class DumpHistoryCliParser implements CliParser<DumpHistoryCommand> {
  public final static String CMD_NAME = CliConsts.DUMP_HISTORY_CMD_NAME;
  ...
  @Override
  public DumpHistoryCommand parse(String[] args) {
    DefaultParser parser = new DefaultParser();
    CommandLine cmdLine;

    cmdLine = CliHelper.tryParse(parser, options, args);

    return DumpHistoryCommand.builder()
  ...
  public void printHelp() {
    ...
    formatter.printHelp(CMD_NAME, DumpHistoryCliParser.options);
  }
